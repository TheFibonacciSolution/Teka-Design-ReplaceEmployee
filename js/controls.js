class TekaLogoOld extends HTMLElement
{
    constructor() {
        super();
...
<div class="nav-logo">  
        ...
        const proc = () => {
            ...
            this.setAttribute(`thickness`, lastClientWidth*.05);
...
customElements.define('teka-logo-old-element',  TekaLogoOld);

class LoginOld extends HTMLElement
{
    constructor() {
...
customElements.define('login-old-element', LoginOld);